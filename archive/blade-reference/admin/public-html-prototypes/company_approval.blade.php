        ...
        <div class="flex-1 overflow-y-auto overflow-x-hidden p-6 lg:p-8 main-scrollbar">
            <div class="max-w-[1400px] mx-auto">
                ...
                <div class="flex gap-8 border-b border-gray-200 mb-8 overflow-x-auto">
                    <button class="px-1 py-3 border-b-2 border-[#3723db] text-[#3723db] font-semibold text-[14px] whitespace-nowrap">Pending (14)</button>
                    <button class="px-1 py-3 border-b-2 border-transparent text-gray-500 font-medium text-[14px] hover:text-gray-700 hover:border-gray-300 transition-colors whitespace-nowrap">Approved (120)</button>
                    <button class="px-1 py-3 border-b-2 border-transparent text-gray-500 font-medium text-[14px] hover:text-gray-700 hover:border-gray-300 transition-colors whitespace-nowrap">Rejected (8)</button>
                </div>
                        ...
                        <table class="w-full text-left border-collapse whitespace-nowrap">
                            ...
                            <tbody class="text-[14px]">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">john.doe@technova.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 98765 43210</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 16, 2024</td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">alice.johnson@gts2024.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 91234 56789</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 15, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">robert.brown@futuresoft.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 99887 76655</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 14, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">victor.ruiz@innovent.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 90909 09090</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 13, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">emily.davis@cloudsync.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 88888 12345</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 12, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">michael.lee@smexpo.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 77777 22222</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 11, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">sophia.martinez@biotech.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 66666 33333</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 10, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">daniel.kim@nextgen.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 55555 44444</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 9, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">laura.wilson@greenenergy.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 44444 55555</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 8, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">james.taylor@healthtech.com</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">+91 33333 66666</td>
                                    <td class="px-6 py-4 text-[#475569] font-medium text-[13px]">May 7, 2024</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2.5">
                                            <button class="flex items-center gap-1.5 px-3 py-1.5 border border-green-500 text-green-600 rounded-[8px] text-[13px] font-bold hover:bg-green-50 transition-colors">
                                                <i class="ph-bold ph-check-circle text-[15px]"></i> Approve

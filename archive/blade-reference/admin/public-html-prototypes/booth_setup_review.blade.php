                        ...
                        <table class="w-full text-left border-collapse whitespace-nowrap">
                            <thead>
                                <tr class="text-[13px] text-gray-500 font-semibold border-b border-gray-100 bg-white">
                                    ...
                                    <th class="px-6 py-4">Booth No.</th>
                            ...
                            <tbody class="text-[14px]">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#0B132C] font-medium text-[13px]">Hall A - Level 1</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="booth_setup_review_details.html" class="w-[32px] h-[32px] inline-flex items-center justify-center rounded-[8px] border border-gray-200 text-gray-500 hover:text-[#3723db] hover:border-[#3723db] transition-colors"><i class="ph ph-eye text-lg"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#0B132C] font-medium text-[13px]">Hall B - Level 2</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#0B132C] font-medium text-[13px]">Hall C - Level 1</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#0B132C] font-medium text-[13px]">Hall E - Level 2</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-[#0B132C] font-medium text-[13px]">Hall F - Level 1</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">

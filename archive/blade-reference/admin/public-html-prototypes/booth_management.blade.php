...
<head>
    ...
    <title>Eproexpo - Booth Management</title>
    <!-- Tailwind CSS -->
        ...
        <div class="flex-1 overflow-y-auto overflow-x-hidden p-6 lg:p-8 main-scrollbar">
            <div class="max-w-[1400px] mx-auto">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                        <h1 class="text-[26px] font-bold text-[#0B132C] mb-1.5">Booth Management</h1>
                        <p class="text-gray-500 text-[14px]">Manage all booth bookings, view booking details, payments and status.</p>
                    </div>
                    <div>
                        <button class="flex items-center justify-center gap-2 bg-[#3723db] hover:bg-[#2515a6] text-white px-5 py-2.5 rounded-[10px] text-[14px] font-semibold shadow-md transition-all w-full sm:w-auto">
                            <i class="ph-bold ph-plus text-lg"></i> Add Booking
                        </button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[22px] font-bold text-[#0B132C] leading-none mb-1">356</span>
                            <span class="text-[12px] text-gray-500 font-medium">Total Bookings</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[22px] font-bold text-[#0B132C] leading-none mb-1">148</span>
                            <span class="text-[12px] text-gray-500 font-medium">Confirmed</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[22px] font-bold text-[#0B132C] leading-none mb-1">72</span>
                            <span class="text-[12px] text-gray-500 font-medium">Pending</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[12px] text-gray-500 font-medium">Cancelled</span>
                        </div>
                    </div>
                    
                    <!-- Total Revenue -->
                    <div class="bg-white rounded-[12px] border border-gray-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        <div class="w-12 h-12 rounded-[10px] bg-[#F4F2FF] text-[#3723db] flex items-center justify-center shrink-0 font-bold text-[24px]">
                            ₹
                        </div>
                        <div class="flex flex-col">
                            <span class="text-[22px] font-bold text-[#0B132C] leading-none mb-1">12,48,500</span>
                            <span class="text-[12px] text-gray-500 font-medium">Total Revenue</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
                    <div class="relative w-full lg:w-[320px]">
                        <i class="ph ph-magnifying-glass absolute left-3.5 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg"></i>
                        <input type="text" placeholder="Search bookings, company, booth no..." class="pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg w-full text-[14px] focus:outline-none focus:border-[#3723db] focus:ring-1 focus:ring-[#3723db] transition-all text-gray-700 shadow-sm">
                    </div>
                    ...
                    <div class="flex flex-wrap items-center gap-4 w-full lg:w-auto">
                        ...
                        <div class="relative w-full sm:w-[190px]">
                            <div class="flex items-center justify-between bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-[13px] text-gray-500 cursor-pointer shadow-sm hover:border-[#3723db] transition-colors">
                ...
                <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm overflow-hidden mb-8">
                        ...
                        <table class="w-full text-left border-collapse whitespace-nowrap">
                            <thead>
                                <tr class="text-[13px] text-gray-500 font-semibold border-b border-gray-100 bg-white">
                                    ...
                                    <th class="px-6 py-4">Exhibitor / Company</th>
                                    <th class="px-6 py-4">Exhibition</th>
                                    <th class="px-6 py-4">Booth(s)</th>
                            ...
                            <tbody class="text-[14px]">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-[#3723db]">BK-2024-0356</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="font-bold text-[#0B132C] text-[13px]">A-101, A-102</span>
                                            <span class="text-[12px] text-gray-500">18 sqm (Standard)</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Hall A - Level 1</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#E6FBF0] text-[#10B981] rounded border border-[#bbf7d0] text-[12px] font-bold">Confirmed</span>
                                    </td>
                                    <td class="px-6 py-4 font-bold text-[#0B132C]">
                                        ₹ 1,80,000
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#E6FBF0] text-[#10B981] rounded border border-[#bbf7d0] text-[12px] font-bold">Paid</span>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-[#3723db]">BK-2024-0355</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#FFF5E6] text-[#FF8A00] rounded border border-[#fed7aa] text-[12px] font-bold">Pending</span>
                                    </td>
                                    <td class="px-6 py-4 font-bold text-[#0B132C]">
                                        ₹ 90,000
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#FFF5E6] text-[#FF8A00] rounded border border-[#fed7aa] text-[12px] font-bold">Partial</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            <button class="w-[32px] h-[32px] flex items-center justify-center rounded-[8px] border border-gray-200 text-gray-500 hover:text-[#3723db] hover:border-[#3723db] transition-colors"><i class="ph ph-eye text-lg"></i></button>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-[#3723db]">BK-2024-0354</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Hall B - Level 2</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-[#3723db]">BK-2024-0353</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#FFE6EB] text-[#FF3B6A] rounded border border-[#fecdd3] text-[12px] font-bold">Unpaid</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            <button class="w-[32px] h-[32px] flex items-center justify-center rounded-[8px] border border-gray-200 text-gray-500 hover:text-[#3723db] hover:border-[#3723db] transition-colors"><i class="ph ph-eye text-lg"></i></button>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-[#3723db]">BK-2024-0352</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="font-bold text-[#0B132C] text-[13px]">C-301, C-302</span>
                                            <span class="text-[12px] text-gray-500">36 sqm (Premium)</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Hall C - Level 1</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-[#3723db]">BK-2024-0351</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="font-bold text-[#0B132C] text-[13px]">Retail Pro Solutions</span>
                                            <span class="text-[12px] text-gray-500">info@retailpro.com</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="font-medium text-[#0B132C] text-[13px]">Retail & E-commerce Expo</span>
                                            <span class="text-[12px] text-gray-500">Mar 12 - Mar 13, 2024</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="font-bold text-[#0B132C] text-[13px]">D-110</span>
                                            <span class="text-[12px] text-gray-500">12 sqm (Standard)</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Hall D - Level 1</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span class="font-medium text-[#0B132C] text-[13px]">Apr 21, 2024</span>
                                            <span class="text-[12px] text-gray-500">03:30 PM</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#FFE6EB] text-[#FF3B6A] rounded border border-[#fecdd3] text-[12px] font-bold">Cancelled</span>
                                    </td>
                                    <td class="px-6 py-4 font-bold text-[#0B132C]">
                                        ₹ 60,000
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#EFF6FF] text-[#3B82F6] rounded border border-[#bfdbfe] text-[12px] font-bold">Refunded</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            <button class="w-[32px] h-[32px] flex items-center justify-center rounded-[8px] border border-gray-200 text-gray-500 hover:text-[#3723db] hover:border-[#3723db] transition-colors"><i class="ph ph-eye text-lg"></i></button>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-[#3723db]">BK-2024-0350</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Hall E - Level 2</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span class="font-bold text-[#3723db]">BK-2024-0349</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Hall F - Level 1</td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                    ...
                    <div class="px-6 py-4 flex flex-col sm:flex-row items-center justify-between text-[13px] text-gray-500 font-medium gap-4 border-t border-gray-100">
                        <div>Showing 1 to 8 of 356 bookings</div>
                        <div class="flex items-center gap-1.5">
                            ...
                            <button class="w-[30px] h-[30px] flex items-center justify-center rounded-md border border-gray-200 hover:bg-gray-50 transition-colors">45</button>

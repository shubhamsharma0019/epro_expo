...
<head>
    ...
    <title>Eproexpo - Pavilion Management</title>
    <!-- Tailwind CSS -->
        ...
        <div class="flex-1 overflow-y-auto overflow-x-hidden p-6 lg:p-8 main-scrollbar">
            <div class="max-w-[1400px] mx-auto">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                        <h1 class="text-[26px] font-bold text-[#0B132C] mb-1.5">Pavilion Management</h1>
                        <p class="text-gray-500 text-[14px]">Manage all pavilions across exhibitions.</p>
                    </div>
                    <div>
                        <button onclick="window.location.href='add_pavilion.html'" class="flex items-center justify-center gap-2 bg-[#3723db] hover:bg-[#2515a6] text-white px-5 py-2.5 rounded-[10px] text-[14px] font-semibold shadow-md transition-all w-full sm:w-auto">
                            <i class="ph-bold ph-plus text-lg"></i> Add Pavilion
                        </button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[22px] font-bold text-[#0B132C] leading-none mb-1">23</span>
                            <span class="text-[12px] text-gray-500 font-medium">Total Pavilions</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[22px] font-bold text-[#0B132C] leading-none mb-1">3</span>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[22px] font-bold text-[#0B132C] leading-none mb-1">1</span>
                ...
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
                    <div class="relative w-full lg:w-auto">
                        <i class="ph ph-magnifying-glass absolute left-3.5 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg"></i>
                        <input type="text" placeholder="Search pavilions..." class="pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg w-full lg:w-[320px] text-[14px] focus:outline-none focus:border-[#3723db] focus:ring-1 focus:ring-[#3723db] transition-all text-gray-700 shadow-sm">
                    </div>
                ...
                <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm overflow-hidden mb-8">
                        ...
                        <table class="w-full text-left border-collapse whitespace-nowrap">
                            <thead>
                                <tr class="text-[13px] text-gray-500 font-semibold border-b border-gray-100 bg-white">
                                    <th class="px-6 py-4">Pavilion Name</th>
                                    <th class="px-6 py-4">Exhibition</th>
                                    <th class="px-6 py-4 flex items-center gap-1 cursor-pointer hover:text-gray-700">Category <i class="ph ph-caret-up-down text-[10px]"></i></th>
                                    ...
                                    <th class="px-6 py-4 flex items-center gap-1 cursor-pointer hover:text-gray-700">Start Date <i class="ph ph-caret-up-down text-[10px]"></i></th>
                                    <th class="px-6 py-4 flex items-center gap-1 cursor-pointer hover:text-gray-700">End Date <i class="ph ph-caret-up-down text-[10px]"></i></th>
                            ...
                            <tbody class="text-[14px]">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="w-8 h-6 overflow-hidden rounded-[2px] shadow-sm border border-gray-100">
                                                <img src="https://flagcdn.com/w40/in.png" alt="India Flag" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="font-bold text-[#0B132C] text-[14px]">India Pavilion</span>
                                                <span class="text-[12px] text-gray-500">Showcasing India's innovation and excellence.</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-3 py-1 bg-[#F4F2FF] text-[#3723db] rounded border border-[#e9e4ff] text-[12px] font-bold">Country</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="text-[#0B132C] font-medium text-[13px]">Hall A - Level 1</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="w-8 h-6 overflow-hidden rounded-[2px] shadow-sm border border-gray-100">
                                                <img src="https://flagcdn.com/w40/us.png" alt="USA Flag" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="font-bold text-[#0B132C] text-[14px]">USA Pavilion</span>
                                                <span class="text-[12px] text-gray-500">Leading the future with technology.</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="w-8 h-6 overflow-hidden rounded-[2px] shadow-sm border border-gray-100">
                                                <img src="https://flagcdn.com/w40/de.png" alt="Germany Flag" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="font-bold text-[#0B132C] text-[14px]">Germany Pavilion</span>
                                                <span class="text-[12px] text-gray-500">Engineering the future together.</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="text-[#0B132C] font-medium text-[13px]">Hall B - Level 2</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="w-8 h-6 overflow-hidden rounded-[2px] shadow-sm border border-gray-100">
                                                <img src="https://flagcdn.com/w40/jp.png" alt="Japan Flag" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="font-bold text-[#0B132C] text-[14px]">Japan Pavilion</span>
                                                <span class="text-[12px] text-gray-500">Innovating for a better tomorrow.</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="w-8 h-6 overflow-hidden rounded-[2px] shadow-sm border border-gray-100">
                                                <img src="https://flagcdn.com/w40/eu.png" alt="EU Flag" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="font-bold text-[#0B132C] text-[14px]">European Union Pavilion</span>
                                                <span class="text-[12px] text-gray-500">United for a sustainable future.</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="text-[#0B132C] font-medium text-[13px]">Hall C - Level 1</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="w-8 h-6 overflow-hidden rounded-[2px] shadow-sm border border-gray-100">
                                                <img src="https://flagcdn.com/w40/ae.png" alt="UAE Flag" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="font-bold text-[#0B132C] text-[14px]">UAE Pavilion</span>
                                                <span class="text-[12px] text-gray-500">Driving progress and prosperity.</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="text-[#0B132C] font-medium text-[13px]">Hall D - Level 1</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="w-8 h-6 overflow-hidden rounded-[2px] shadow-sm border border-gray-100">
                                                <img src="https://flagcdn.com/w40/cn.png" alt="China Flag" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="font-bold text-[#0B132C] text-[14px]">China Pavilion</span>
                                                <span class="text-[12px] text-gray-500">Empowering global collaboration.</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="text-[#0B132C] font-medium text-[13px]">Hall E - Level 2</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="w-8 h-6 overflow-hidden rounded-[2px] shadow-sm border border-gray-100">
                                                <img src="https://flagcdn.com/w40/gb.png" alt="UK Flag" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex flex-col">
                                                <span class="font-bold text-[#0B132C] text-[14px]">UK Pavilion</span>
                                                <span class="text-[12px] text-gray-500">Innovation. Growth. Sustainability.</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="text-[#0B132C] font-medium text-[13px]">Hall F - Level 1</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                    ...
                    <div class="px-6 py-4 flex flex-col sm:flex-row items-center justify-between text-[13px] text-gray-500 font-medium gap-4 border-t border-gray-100">
                        <div>Showing 1 to 8 of 23 pavilions</div>

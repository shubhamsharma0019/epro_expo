        ...
        <div class="flex-1 overflow-y-auto overflow-x-hidden p-6 lg:p-8 main-scrollbar">
            <div class="max-w-[1400px] mx-auto">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    ...
                    <div>
                        <button onclick="window.location.href='add_booth.html'" class="flex items-center justify-center gap-2 bg-[#3723db] hover:bg-[#2515a6] text-white px-5 py-2.5 rounded-[10px] text-[14px] font-semibold shadow-md transition-all w-full sm:w-auto">
                        ...
                        <table class="w-full text-left border-collapse whitespace-nowrap">
                            <thead>
                                <tr class="text-[13px] text-gray-500 font-semibold border-b border-gray-100 bg-white">
                                    <th class="px-6 py-4"><div class="flex items-center gap-1 cursor-pointer hover:text-gray-700 w-max">Booth No. <i class="ph ph-caret-up-down text-[10px]"></i></div></th>
                                    <th class="px-6 py-4"><div class="flex items-center gap-1 cursor-pointer hover:text-gray-700 w-max">Exhibition <i class="ph ph-caret-up-down text-[10px]"></i></div></th>
                                    <th class="px-6 py-4"><div class="flex items-center gap-1 cursor-pointer hover:text-gray-700 w-max">Pavilion <i class="ph ph-caret-up-down text-[10px]"></i></div></th>
                                    <th class="px-6 py-4"><div class="flex items-center gap-1 cursor-pointer hover:text-gray-700 w-max">Hall <i class="ph ph-caret-up-down text-[10px]"></i></div></th>
                                    <th class="px-6 py-4"><div class="flex items-center gap-1 cursor-pointer hover:text-gray-700 w-max">Category <i class="ph ph-caret-up-down text-[10px]"></i></div></th>
                                    <th class="px-6 py-4"><div class="flex items-center gap-1 cursor-pointer hover:text-gray-700 w-max">Size (sq.m) <i class="ph ph-caret-up-down text-[10px]"></i></div></th>
                                    <th class="px-6 py-4"><div class="flex items-center gap-1 cursor-pointer hover:text-gray-700 w-max">Status <i class="ph ph-caret-up-down text-[10px]"></i></div></th>
                                    <th class="px-6 py-4"><div class="flex items-center gap-1 cursor-pointer hover:text-gray-700 w-max">Availability <i class="ph ph-caret-up-down text-[10px]"></i></div></th>
                            ...
                            <tbody class="text-[14px]">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Standard</td>
                                    <td class="px-6 py-4 text-gray-700 text-[13px]">9 (3m x 3m)</td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Hall A - Level 1</td>
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Premium</td>
                                    <td class="px-6 py-4 text-gray-700 text-[13px]">18 (3m x 6m)</td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Island</td>
                                    <td class="px-6 py-4 text-gray-700 text-[13px]">36 (6m x 6m)</td>
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#E6FBF0] text-[#10B981] rounded border border-[#bbf7d0] text-[12px] font-bold">Available</span>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Standard</td>
                                    <td class="px-6 py-4 text-gray-700 text-[13px]">12 (4m x 3m)</td>
                                    <td class="px-6 py-4">
                                        <span class="px-2.5 py-1 bg-[#E6FBF0] text-[#10B981] rounded border border-[#bbf7d0] text-[12px] font-bold">Available</span>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-gray-700 font-medium text-[13px]">Premium</td>
                                    <td class="px-6 py-4 text-gray-700 text-[13px]">24 (4m x 6m)</td>
                                    <td class="px-6 py-4">

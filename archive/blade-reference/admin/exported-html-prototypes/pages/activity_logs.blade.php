            ...
            <div class="max-w-[1600px] mx-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white p-5 rounded-[12px] border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="text-[11px] text-gray-400 font-medium flex items-center whitespace-nowrap overflow-hidden text-ellipsis">
                ...
                <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm flex flex-col overflow-hidden">
                    ...
                    <div class="px-6 flex flex-col lg:flex-row lg:items-center justify-between border-b border-gray-100 gap-4 pt-4 lg:pt-0 lg:h-[72px]">
                        ...
                        <!-- Tabs -->
                        <div class="flex items-center gap-6 overflow-x-auto no-scrollbar lg:pt-0 pt-2 h-full">
                            <button class="h-full pb-3 lg:pb-0 border-b-[3px] border-[#3723db] text-[#3723db] font-bold text-[14px] whitespace-nowrap pt-1">All Activities</button>
                            <button class="h-full pb-3 lg:pb-0 border-b-[3px] border-transparent text-gray-500 hover:text-[#0B132C] font-semibold text-[14px] whitespace-nowrap transition-colors pt-1">User Activities</button>
                            <button class="h-full pb-3 lg:pb-0 border-b-[3px] border-transparent text-gray-500 hover:text-[#0B132C] font-semibold text-[14px] whitespace-nowrap transition-colors pt-1">System Events</button>
                            <button class="h-full pb-3 lg:pb-0 border-b-[3px] border-transparent text-gray-500 hover:text-[#0B132C] font-semibold text-[14px] whitespace-nowrap transition-colors pt-1">Security Events</button>
                        </div>
                        ...
                        <table class="w-full text-left border-collapse min-w-[1100px]">
                            <thead>
                                <tr class="text-[12px] text-gray-500 border-b border-gray-50 bg-white">
                                    <th class="px-6 py-4 font-semibold w-[160px]">Date & Time</th>
                                    <th class="px-6 py-4 font-semibold w-[220px]">User</th>
                                    <th class="px-6 py-4 font-semibold w-[140px]">Action</th>
                                    <th class="px-6 py-4 font-semibold w-[160px]">Module</th>
                                    <th class="px-6 py-4 font-semibold">Description</th>
                                    <th class="px-6 py-4 font-semibold w-[140px]">IP Address</th>
                            ...
                            <tbody class="text-[13px]">
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#ECFDF5] text-[#10B981] rounded-[6px] text-[11px] font-bold">Created</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Booth Booking</td>
                                    <td class="px-6 py-4 text-gray-600">Created a new booth booking for Global Tech Summit 2024</td>
                                    <td class="px-6 py-4 text-gray-600">103.21.244.10</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#EFF6FF] text-[#3B82F6] rounded-[6px] text-[11px] font-bold">Updated</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Company</td>
                                    <td class="px-6 py-4 text-gray-600">Updated company information for TechNova Solutions</td>
                                    <td class="px-6 py-4 text-gray-600">103.21.244.10</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#ECFDF5] text-[#10B981] rounded-[6px] text-[11px] font-bold">Created</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Enquiry / Leads</td>
                                    <td class="px-6 py-4 text-gray-600">Created a new enquiry from Future AI Conference</td>
                                    <td class="px-6 py-4 text-gray-600">103.45.67.89</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#FEF2F2] text-[#EF4444] rounded-[6px] text-[11px] font-bold">Deleted</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Ticket</td>
                                    <td class="px-6 py-4 text-gray-600">Deleted ticket INV-2024-1542</td>
                                    <td class="px-6 py-4 text-gray-600">103.31.45.22</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#F4F2FF] text-[#3723db] rounded-[6px] text-[11px] font-bold">Downloaded</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Invoice</td>
                                    <td class="px-6 py-4 text-gray-600">Downloaded invoice INV-2024-1556</td>
                                    <td class="px-6 py-4 text-gray-600">103.21.244.10</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#EFF6FF] text-[#3B82F6] rounded-[6px] text-[11px] font-bold">Login</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Authentication</td>
                                    <td class="px-6 py-4 text-gray-600">User logged in to the system</td>
                                    <td class="px-6 py-4 text-gray-600">122.176.32.11</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#EFF6FF] text-[#3B82F6] rounded-[6px] text-[11px] font-bold">Updated</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Payment</td>
                                    <td class="px-6 py-4 text-gray-600">Updated payment status for INV-2024-1555</td>
                                    <td class="px-6 py-4 text-gray-600">103.45.67.89</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#FEF2F2] text-[#EF4444] rounded-[6px] text-[11px] font-bold">Failed Login</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Authentication</td>
                                    <td class="px-6 py-4 text-gray-600">Failed login attempt</td>
                                    <td class="px-6 py-4 text-gray-600">185.199.108.25</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#EF4444] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#EF4444]"></div> Failed</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#FFF7ED] text-[#EA580C] rounded-[6px] text-[11px] font-bold">Assigned</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Meeting</td>
                                    <td class="px-6 py-4 text-gray-600">Assigned a meeting to Rohit Sharma</td>
                                    <td class="px-6 py-4 text-gray-600">103.21.244.10</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4"><span class="px-2.5 py-1 bg-[#ECFDF5] text-[#10B981] rounded-[6px] text-[11px] font-bold">Created</span></td>
                                    <td class="px-6 py-4 text-[#0B132C] font-medium">Exhibition</td>
                                    <td class="px-6 py-4 text-gray-600">Created exhibition - Healthcare Leaders Summit</td>
                                    <td class="px-6 py-4 text-gray-600">122.176.32.11</td>
                                    <td class="px-6 py-4"><span class="flex items-center gap-1.5 text-[#10B981] font-medium text-[13px]"><div class="w-2 h-2 rounded-full bg-[#10B981]"></div> Success</span></td>
                                    <td class="px-6 py-4 text-center"><button class="text-gray-400 hover:text-[#0B132C] transition-colors"><i class="ph-bold ph-dots-three text-lg"></i></button></td>
                                </tr>
                    ...
                    <!-- Pagination Footer -->
                    <div class="px-6 py-4 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between text-[13px] text-gray-500 font-medium gap-4">

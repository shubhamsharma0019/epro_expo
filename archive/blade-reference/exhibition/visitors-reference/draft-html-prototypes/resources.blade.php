                ...
                <div class="flex-1 flex flex-col min-w-[800px]">
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden mb-6 hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                        ...
                        <div class="grid grid-cols-[3fr_1fr_1fr_1fr_auto] gap-4 p-4 border-b border-gray-100 items-center hover:bg-gray-50 transition-colors group">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-10 rounded bg-[#020617] relative overflow-hidden shrink-0 flex items-center justify-center">
                                    <div class="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=100&auto=format&fit=crop')] bg-cover bg-center mix-blend-luminosity"></div>
                                    <div class="text-blue-500 text-[10px] font-bold relative z-10">TN</div>
                                </div>
                                <div>
                                    <h3 class="text-[13px] font-bold text-[#1E1B4B] mb-0.5 group-hover:text-primary-600 transition-colors cursor-pointer">Company Profile 2024</h3>
                                    <p class="text-[11px] text-gray-500 line-clamp-1">An overview of TechNext Solutions, our vision, mission, and key offerings.</p>
                                </div>
                            </div>
                            <div><span class="bg-purple-50 text-purple-600 text-[10px] font-bold px-2 py-1 rounded">Brochure</span></div>
                            <div class="text-[12px] text-gray-500 font-medium">2.4 MB</div>
                            <div class="text-[12px] text-gray-500 font-medium">May 10, 2024</div>
                            <div class="w-10 flex justify-end">
                                <button class="text-primary-600 hover:bg-primary-50 w-8 h-8 rounded flex items-center justify-center transition-colors"><i class="ph-bold ph-download-simple text-[16px]"></i></button>
                            </div>
                        </div>

                        <!-- Row 2: AI Platform Overview -->
                        <div class="grid grid-cols-[3fr_1fr_1fr_1fr_auto] gap-4 p-4 border-b border-gray-100 items-center hover:bg-gray-50 transition-colors group">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-10 rounded bg-[#020617] relative overflow-hidden shrink-0 flex items-center justify-center">
                                    <div class="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=100&auto=format&fit=crop')] bg-cover bg-center mix-blend-luminosity"></div>
                                    <div class="text-blue-500 text-[10px] font-bold relative z-10">TN</div>
                                </div>
                                <div>
                                    <h3 class="text-[13px] font-bold text-[#1E1B4B] mb-0.5 group-hover:text-primary-600 transition-colors cursor-pointer">AI Platform Overview</h3>
                                    <p class="text-[11px] text-gray-500 line-clamp-1">Explore our AI platform capabilities and how we drive business transformation.</p>
                                </div>
                            </div>
                            <div><span class="bg-purple-50 text-purple-600 text-[10px] font-bold px-2 py-1 rounded">Brochure</span></div>
                            <div class="text-[12px] text-gray-500 font-medium">3.1 MB</div>
                            <div class="text-[12px] text-gray-500 font-medium">May 8, 2024</div>
                            <div class="w-10 flex justify-end">
                                <button class="text-primary-600 hover:bg-primary-50 w-8 h-8 rounded flex items-center justify-center transition-colors"><i class="ph-bold ph-download-simple text-[16px]"></i></button>
                            </div>
                        </div>

                        <!-- Row 3: Product Datasheet -->
                        <div class="grid grid-cols-[3fr_1fr_1fr_1fr_auto] gap-4 p-4 border-b border-gray-100 items-center hover:bg-gray-50 transition-colors group">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-10 rounded bg-[#020617] relative overflow-hidden shrink-0 flex items-center justify-center">
                                    <div class="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=100&auto=format&fit=crop')] bg-cover bg-center mix-blend-luminosity"></div>
                                    <div class="text-blue-500 text-[10px] font-bold relative z-10">TN</div>
                                </div>
                                <div>
                                    <h3 class="text-[13px] font-bold text-[#1E1B4B] mb-0.5 group-hover:text-primary-600 transition-colors cursor-pointer">Product Datasheet</h3>
                                    <p class="text-[11px] text-gray-500 line-clamp-1">Detailed technical specifications and features of our AI platform.</p>
                                </div>
                            </div>
                            <div><span class="bg-green-50 text-green-600 text-[10px] font-bold px-2 py-1 rounded">Datasheet</span></div>
                            <div class="text-[12px] text-gray-500 font-medium">1.2 MB</div>
                            <div class="text-[12px] text-gray-500 font-medium">May 7, 2024</div>
                            <div class="w-10 flex justify-end">
                                <button class="text-primary-600 hover:bg-primary-50 w-8 h-8 rounded flex items-center justify-center transition-colors"><i class="ph-bold ph-download-simple text-[16px]"></i></button>
                            </div>
                        </div>

                        <!-- Row 4: Use Case - Manufacturing -->
                        <div class="grid grid-cols-[3fr_1fr_1fr_1fr_auto] gap-4 p-4 border-b border-gray-100 items-center hover:bg-gray-50 transition-colors group">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-10 rounded bg-[#020617] relative overflow-hidden shrink-0 flex items-center justify-center">
                                    <div class="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=100&auto=format&fit=crop')] bg-cover bg-center mix-blend-luminosity"></div>
                                    <div class="text-blue-500 text-[10px] font-bold relative z-10">TN</div>
                                </div>
                                <div>
                                    <h3 class="text-[13px] font-bold text-[#1E1B4B] mb-0.5 group-hover:text-primary-600 transition-colors cursor-pointer">Use Case – Manufacturing</h3>
                                    <p class="text-[11px] text-gray-500 line-clamp-1">How TechNext AI helps manufacturing companies improve efficiency.</p>
                                </div>
                            </div>
                            <div><span class="bg-orange-50 text-orange-600 text-[10px] font-bold px-2 py-1 rounded">Case Study</span></div>
                            <div class="text-[12px] text-gray-500 font-medium">1.8 MB</div>
                            <div class="text-[12px] text-gray-500 font-medium">May 5, 2024</div>
                            <div class="w-10 flex justify-end">
                                <button class="text-primary-600 hover:bg-primary-50 w-8 h-8 rounded flex items-center justify-center transition-colors"><i class="ph-bold ph-download-simple text-[16px]"></i></button>
                            </div>
                        </div>

                        <!-- Row 5: Solution Brief -->
                        <div class="grid grid-cols-[3fr_1fr_1fr_1fr_auto] gap-4 p-4 border-b border-gray-100 items-center hover:bg-gray-50 transition-colors group">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-10 rounded bg-[#020617] relative overflow-hidden shrink-0 flex items-center justify-center">
                                    <div class="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=100&auto=format&fit=crop')] bg-cover bg-center mix-blend-luminosity"></div>
                                    <div class="text-blue-500 text-[10px] font-bold relative z-10">TN</div>
                                </div>
                                <div>
                                    <h3 class="text-[13px] font-bold text-[#1E1B4B] mb-0.5 group-hover:text-primary-600 transition-colors cursor-pointer">Solution Brief</h3>
                                    <p class="text-[11px] text-gray-500 line-clamp-1">A quick overview of our AI & Automation solutions.</p>
                                </div>
                            </div>
                            <div><span class="bg-purple-50 text-purple-600 text-[10px] font-bold px-2 py-1 rounded">Brochure</span></div>
                            <div class="text-[12px] text-gray-500 font-medium">1.1 MB</div>
                            <div class="text-[12px] text-gray-500 font-medium">May 4, 2024</div>
                            <div class="w-10 flex justify-end">
                                <button class="text-primary-600 hover:bg-primary-50 w-8 h-8 rounded flex items-center justify-center transition-colors"><i class="ph-bold ph-download-simple text-[16px]"></i></button>
                            </div>
                        </div>

                        <!-- Row 6: Platform Architecture -->
                        <div class="grid grid-cols-[3fr_1fr_1fr_1fr_auto] gap-4 p-4 border-b border-gray-100 items-center hover:bg-gray-50 transition-colors group">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-10 rounded bg-[#020617] relative overflow-hidden shrink-0 flex items-center justify-center">
                                    <div class="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=100&auto=format&fit=crop')] bg-cover bg-center mix-blend-luminosity"></div>
                                    <div class="text-blue-500 text-[10px] font-bold relative z-10">TN</div>
                                </div>
                                <div>
                                    <h3 class="text-[13px] font-bold text-[#1E1B4B] mb-0.5 group-hover:text-primary-600 transition-colors cursor-pointer">Platform Architecture</h3>
                                    <p class="text-[11px] text-gray-500 line-clamp-1">Technical architecture and security of our AI platform.</p>
                                </div>
                            </div>
                            <div><span class="bg-green-50 text-green-600 text-[10px] font-bold px-2 py-1 rounded">Datasheet</span></div>
                            <div class="text-[12px] text-gray-500 font-medium">1.5 MB</div>
                            <div class="text-[12px] text-gray-500 font-medium">May 3, 2024</div>
                            <div class="w-10 flex justify-end">
                                <button class="text-primary-600 hover:bg-primary-50 w-8 h-8 rounded flex items-center justify-center transition-colors"><i class="ph-bold ph-download-simple text-[16px]"></i></button>
                            </div>
                        </div>

                        <!-- Row 7: Product Demo Video -->
                        <div class="grid grid-cols-[3fr_1fr_1fr_1fr_auto] gap-4 p-4 border-b border-gray-100 items-center hover:bg-gray-50 transition-colors group cursor-pointer" onclick="window.location.href='watch-demo.html'">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-10 rounded bg-[#4A22E0] relative overflow-hidden shrink-0 flex items-center justify-center shadow-inner">
                                    <i class="ph-fill ph-play text-white text-[18px]"></i>
                                </div>
                                <div>
                                    <h3 class="text-[13px] font-bold text-[#1E1B4B] mb-0.5 group-hover:text-primary-600 transition-colors">Product Demo Video</h3>
                                    <p class="text-[11px] text-gray-500 line-clamp-1">Watch a quick demo of our AI platform in action.</p>
                                </div>
                            </div>
                            <div><span class="bg-blue-50 text-blue-600 text-[10px] font-bold px-2 py-1 rounded">Video</span></div>
                            <div class="text-[12px] text-gray-500 font-medium">45.6 MB</div>
                            <div class="text-[12px] text-gray-500 font-medium">May 2, 2024</div>
                            <div class="w-10 flex justify-end">
                                <button class="text-primary-600 hover:bg-primary-50 w-8 h-8 rounded flex items-center justify-center transition-colors"><i class="ph-bold ph-download-simple text-[16px]"></i></button>
                            </div>
                        </div>
                        ...
                        <!-- Row 8: Whitepaper -->
                        <div class="grid grid-cols-[3fr_1fr_1fr_1fr_auto] gap-4 p-4 items-center hover:bg-gray-50 transition-colors group">
                            <div class="flex items-center gap-4">
                                <div class="w-14 h-10 rounded bg-[#020617] relative overflow-hidden shrink-0 flex items-center justify-center">
                                    <div class="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1488229297570-58520851e868?q=80&w=100&auto=format&fit=crop')] bg-cover bg-center mix-blend-luminosity"></div>
                                    <div class="text-blue-500 text-[10px] font-bold relative z-10">TN</div>
                                </div>
                                <div>
                                    <h3 class="text-[13px] font-bold text-[#1E1B4B] mb-0.5 group-hover:text-primary-600 transition-colors cursor-pointer">Whitepaper: The Future of AI</h3>
                                    <p class="text-[11px] text-gray-500 line-clamp-1">In-depth analysis on AI trends and future opportunities.</p>
                                </div>
                            </div>
                            <div><span class="bg-yellow-50 text-yellow-600 text-[10px] font-bold px-2 py-1 rounded">Whitepaper</span></div>
                            <div class="text-[12px] text-gray-500 font-medium">2.0 MB</div>
                            <div class="text-[12px] text-gray-500 font-medium">May 1, 2024</div>
                            <div class="w-10 flex justify-end">
                                <button class="text-primary-600 hover:bg-primary-50 w-8 h-8 rounded flex items-center justify-center transition-colors"><i class="ph-bold ph-download-simple text-[16px]"></i></button>
                            </div>
                        </div>

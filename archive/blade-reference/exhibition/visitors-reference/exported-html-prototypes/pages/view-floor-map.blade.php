            ...
            <div class="flex gap-8 max-w-[1500px]">
                ...
                <div class="flex-1 flex flex-col min-w-[800px]">
                    ...
                    <div class="grid grid-cols-4 gap-4 pb-20">
                        ...
                        <!-- Booth 105 -->
                        <div onclick="window.location.href='exhibitor-details.html?id=105'" class="bg-white border border-gray-100 rounded-[16px] p-4 flex flex-col h-[220px] shadow-sm hover:shadow-md transition-shadow relative cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            <div class="flex justify-between items-center mb-4">
                        ...
                        <!-- Booth 106 -->
                        <div onclick="window.location.href='exhibitor-details.html?id=106'" class="bg-white border border-gray-100 rounded-[16px] p-4 flex flex-col h-[220px] shadow-sm hover:shadow-md transition-shadow relative cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            <div class="flex justify-between items-center mb-4">
                        ...
                        <!-- Booth 107 -->
                        <div onclick="window.location.href='exhibitor-details.html?id=107'" class="bg-white border border-gray-100 rounded-[16px] p-4 flex flex-col h-[220px] shadow-sm hover:shadow-md transition-shadow relative cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            <div class="flex justify-between items-center mb-4">
                        ...
                        <!-- Booth 108 -->
                        <div onclick="window.location.href='exhibitor-details.html?id=108'" class="bg-white border border-gray-100 rounded-[16px] p-4 flex flex-col h-[220px] shadow-sm hover:shadow-md transition-shadow relative cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            <div class="flex justify-between items-center mb-4">
                        ...
                        <!-- Booth 109 -->
                        <div onclick="window.location.href='exhibitor-details.html?id=109'" class="bg-white border border-gray-100 rounded-[16px] p-4 flex flex-col h-[220px] shadow-sm hover:shadow-md transition-shadow relative cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            <div class="flex justify-between items-center mb-4">
                        ...
                        <!-- Booth 110 -->
                        <div onclick="window.location.href='exhibitor-details.html?id=110'" class="bg-white border border-gray-100 rounded-[16px] p-4 flex flex-col h-[220px] shadow-sm hover:shadow-md transition-shadow relative cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            <div class="flex justify-between items-center mb-4">
                        ...
                        <!-- Booth 111 -->
                        <div onclick="window.location.href='exhibitor-details.html?id=111'" class="bg-white border border-gray-100 rounded-[16px] p-4 flex flex-col h-[220px] shadow-sm hover:shadow-md transition-shadow relative cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            <div class="flex justify-between items-center mb-4">
                        ...
                        <!-- Booth 112 -->
                        <div onclick="window.location.href='exhibitor-details.html?id=112'" class="bg-white border border-gray-100 rounded-[16px] p-4 flex flex-col h-[220px] shadow-sm hover:shadow-md transition-shadow relative cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            <div class="flex justify-between items-center mb-4">

        ...
        <div class="px-10 py-10 max-w-[1250px] w-full flex mx-auto flex-1 gap-14">
            ...
            <div class="w-[440px] flex flex-col gap-10">
                ...
                <div class="flex flex-col gap-4 mt-auto">
                    <button onclick="window.location.href='event_company_dashboard.html'" class="w-full bg-[#4C10D0] text-white py-4 rounded-lg text-[14px] font-bold hover:bg-[#3d0ba8] transition-colors shadow-[0_4px_14px_rgba(76,16,208,0.3)]">
                        Submit for Review
                    </button>

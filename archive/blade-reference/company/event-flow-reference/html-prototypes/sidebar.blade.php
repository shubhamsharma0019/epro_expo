<div class="w-[280px] h-screen border-r border-gray-100 flex flex-col py-8 px-6 bg-white fixed top-0 left-0 font-sans shadow-[2px_0_10px_rgba(0,0,0,0.02)] z-50">
    ...
    <nav class="flex flex-col gap-1.5 flex-1 overflow-y-auto min-h-0" style="scrollbar-width: none;">
        <!-- Dashboard (Active) -->
        <a href="#" class="flex items-center gap-4 px-4 py-3.5 bg-[#F4F1FF] text-[#5B32F6] text-[15px] font-semibold rounded-xl transition-colors">
        ...
        <!-- Agenda -->
        <a href="#" class="flex items-center gap-4 px-4 py-3.5 text-[#1C1364] hover:bg-[#F8F9FA] text-[15px] font-medium rounded-xl transition-colors group">
            <svg class="text-[#1C1364] w-5 h-5 stroke-[2.2]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect><path d="M9 14l2 2 4-4"></path></svg>
            Agenda
        </a>
        
        <!-- Speakers -->
        <a href="#" class="flex items-center gap-4 px-4 py-3.5 text-[#1C1364] hover:bg-[#F8F9FA] text-[15px] font-medium rounded-xl transition-colors group">
            <svg class="text-[#1C1364] w-5 h-5 stroke-[2.2]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
            Speakers
        </a>
        
        <!-- Sponsors -->
        <a href="#" class="flex items-center gap-4 px-4 py-3.5 text-[#1C1364] hover:bg-[#F8F9FA] text-[15px] font-medium rounded-xl transition-colors group">
            <svg class="text-[#1C1364] w-5 h-5 stroke-[2.2]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
            Sponsors
        </a>
        ...
        <!-- Meetings -->
        <a href="#" class="flex items-center gap-4 px-4 py-3.5 text-[#1C1364] hover:bg-[#F8F9FA] text-[15px] font-medium rounded-xl transition-colors group">
            <svg class="text-[#1C1364] w-5 h-5 stroke-[2.2]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path><path d="M9 9h6"></path><path d="M9 13h6"></path></svg>
            Meetings
        </a>

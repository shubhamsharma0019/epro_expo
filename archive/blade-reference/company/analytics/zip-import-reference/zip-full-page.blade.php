...
<head>
    ...
    <link rel="stylesheet" href="http://127.0.0.1:8000/assets/exhibition/styles.css">
</head>
<body class="bg-[#F9FAFB] text-gray-900 font-sans">

    <!-- Sidebar -->
    <aside class="fixed inset-y-0 left-0 w-80 bg-white border-r border-gray-100 flex flex-col z-20 px-5 py-6 shadow-sm">
        ...
        <ul class="flex flex-col gap-3 list-none">
            <li>
                <a href="dashboard.html" class="flex items-center px-5 py-4 rounded-xl text-gray-900 no-underline transition-all duration-200 hover:bg-gray-50 cursor-pointer">
                    <i class="ph ph-squares-four text-2xl mr-5 text-gray-900 transition-colors duration-200"></i>
            ...
            <li>
                <a href="analytics.html" class="flex items-center px-5 py-4 rounded-xl text-gray-900 no-underline transition-all duration-200 hover:bg-gray-50 active:bg-primary-light active:text-primary bg-primary-light text-primary">
                    <i class="ph ph-chart-bar text-2xl mr-5 text-primary transition-colors duration-200"></i>
    ...
    <!-- Top Navigation -->
    <header class="fixed top-0 left-80 right-0 h-[80px] bg-white border-b border-gray-100 flex items-center justify-between px-8 z-20">
        <!-- Center Nav -->
        <nav class="flex space-x-8">
            <a href="javascript:void(0)" class="text-[#1E1B4B] font-bold text-[14px]">Explore Events</a>
            <a href="javascript:void(0)" class="text-[#6B7280] hover:text-[#1E1B4B] font-medium text-[14px]">Portfolios</a>
            <a href="javascript:void(0)" class="text-[#6B7280] hover:text-[#1E1B4B] font-medium text-[14px]">Hubs</a>
            <a href="javascript:void(0)" class="text-[#6B7280] hover:text-[#1E1B4B] font-medium text-[14px]">Booths</a>
            <a href="javascript:void(0)" class="text-[#6B7280] hover:text-[#1E1B4B] font-medium text-[14px]">Features</a>
            <a href="javascript:void(0)" class="text-[#6B7280] hover:text-[#1E1B4B] font-medium text-[14px]">Pricing</a>
            <a href="javascript:void(0)" class="text-[#6B7280] hover:text-[#1E1B4B] font-medium text-[14px]">Resources</a>
        </nav>
        ...
        <div class="flex items-center space-x-6">
            ...
            <div class="flex items-center pl-6 border-l border-gray-200">
                <img src="http://127.0.0.1:8000/assets/exhibition/images/avatar.png" alt="Profile" class="w-10 h-10 rounded-full border border-gray-200">
                <div class="ml-3">
    ...
    <!-- Main Content -->
    <main class="ml-80 pt-[80px] min-h-screen bg-[#F9FAFB] p-8">

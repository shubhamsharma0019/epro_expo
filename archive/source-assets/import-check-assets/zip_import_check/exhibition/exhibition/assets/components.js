const sidebarHTML = `
<aside class="w-[240px] bg-white border-r border-gray-200 h-screen fixed left-0 top-0 flex flex-col justify-between z-20">
    <div>
        <div class="h-[80px] flex items-center px-6 border-b border-transparent">
            <a href="booking-details.html" class="flex items-center">
        ...
        <!-- Menu Items -->
        <nav id="sidebar-nav" class="flex-1 mt-6 px-4 space-y-1 overflow-y-auto">
            <a href="index.html" data-page="index" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="pavilions.html" data-page="pavilions" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="halls.html" data-page="halls" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="booth-search.html" data-page="booth-search" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="booking-details.html" data-page="booking-details" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="leads.html" data-page="leads" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="add-products.html" data-page="add-products" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="media-gallery.html" data-page="media-gallery" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="team-members.html" data-page="team-members" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                Team Members
            </a>
            <a href="meetings.html" data-page="meetings" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                Meetings
            </a>
            <a href="sessions.html" data-page="sessions" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="preview.html" data-page="preview" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="publish.html" data-page="publish" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
            ...
            <a href="support.html" data-page="support" class="flex items-center px-4 py-3 text-[#6B7280] hover:bg-gray-50 hover:text-[#3D1B9B] transition-colors rounded-xl mb-1 font-medium">
    ...
    <div class="p-4 border-t border-transparent">
        <a href="#" class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-50 text-[#6B7280] transition-colors font-semibold text-[13px]">
...
const topnavHTML = `
<header class="h-[80px] bg-white border-b border-gray-100 fixed top-0 right-0 left-[240px] flex items-center justify-between px-8 z-10">
    <div class="flex-1 flex justify-center">
        <nav class="hidden lg:flex space-x-8 text-[13px] font-bold text-[#1E1B4B]">
            <a href="#" class="hover:text-[#3D1B9B] transition-colors">Explore Events</a>
            <a href="#" class="hover:text-[#3D1B9B] transition-colors">Pavilions</a>
            <a href="#" class="hover:text-[#3D1B9B] transition-colors">Halls</a>
            <a href="#" class="hover:text-[#3D1B9B] transition-colors">Booths</a>
            <a href="#" class="hover:text-[#3D1B9B] transition-colors">Features</a>
            <a href="#" class="hover:text-[#3D1B9B] transition-colors">Pricing</a>
            <a href="#" class="hover:text-[#3D1B9B] transition-colors">Resources</a>
        </nav>
    </div>
    <div class="flex items-center justify-end space-x-6">
        <div class="flex items-center text-[13px] font-bold text-[#1E1B4B] cursor-pointer">
            <svg class="w-4 h-4 mr-1.5 text-[#3D1B9B]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path></svg>
            EN
        ...
        <div class="flex items-center gap-3 cursor-pointer">
            <img src="./assets/images/avatar.png" alt="John Doe" class="h-10 w-10 rounded-full object-cover">
            <div class="flex flex-col hidden sm:flex justify-center">
                <span class="text-[13px] font-bold text-[#1E1B4B] leading-tight">John Doe</span>
                <span class="text-[12px] text-gray-500 italic">Exhibitor</span>
            </div>
            <svg class="w-3 h-3 text-gray-500 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
        </div>
    </div>
</header>
`;
...
const stepsData = [
    { id: 1, title: "Company Profile", desc: "Add your company details and contact information.", link: "company-profile.html" },
    { id: 2, title: "Booth Branding", desc: "Customize your booth look and feel.", link: "booth-branding.html" },
    { id: 3, title: "Products", desc: "Add and showcase your products or services.", link: "add-products.html" },
    { id: 4, title: "Documents", desc: "Upload brochures, certificates and other documents.", link: "upload-documents.html" },
    { id: 5, title: "Catalogues", desc: "Upload your digital catalogues and lookbooks.", link: "upload-catalogues.html" },

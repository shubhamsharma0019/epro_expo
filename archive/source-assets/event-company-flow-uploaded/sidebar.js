...
<div id="sidebar-overlay" class="fixed inset-0 bg-black/40 z-40 hidden lg:hidden opacity-0 transition-opacity duration-300"></div>

<!-- Sidebar Menu -->
<div id="sidebar-menu" class="w-[280px] h-screen border-r border-gray-100 flex flex-col py-8 px-6 bg-white fixed top-0 left-0 font-sans shadow-[2px_0_10px_rgba(0,0,0,0.02)] z-50 transition-transform duration-300 lg:translate-x-0 -translate-x-full">
    <!-- Logo & Close Button -->
    <div class="flex items-center justify-between mb-10 pl-2">
        ...
        <button id="sidebar-close-btn" class="lg:hidden text-textMuted hover:text-primary transition-colors focus:outline-none">

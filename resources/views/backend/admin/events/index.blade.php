                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-4 xl:p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[11px] xl:text-[12px] text-gray-500 font-medium whitespace-normal">Total Events</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-4 xl:p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[11px] xl:text-[12px] text-gray-500 font-medium whitespace-normal">Upcoming Events</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-4 xl:p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[11px] xl:text-[12px] text-gray-500 font-medium whitespace-normal">Ongoing Events</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-4 xl:p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[11px] xl:text-[12px] text-gray-500 font-medium whitespace-normal">Completed Events</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-4 xl:p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[11px] xl:text-[12px] text-gray-500 font-medium whitespace-normal">Total Speakers</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[12px] border border-gray-100 p-4 xl:p-5 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-[11px] xl:text-[12px] text-gray-500 font-medium whitespace-normal">Total Registrations</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col xl:flex-row gap-6 items-start">
                    ...
                    <div class="w-full xl:flex-1 flex flex-col gap-6">
                        ...
                        <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm overflow-hidden">
                                ...
                                <table class="w-full text-left border-collapse whitespace-normal">
                                    <thead>
                                        <tr class="text-[12px] text-gray-500 font-semibold border-b border-gray-100 bg-white">
                                            ...
                                            <th class="px-3 py-3">Registrations</th>
                                    ...
                                    <tbody class="text-[13px]">
                                        ...
                                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-3 py-3 text-gray-600 font-medium">Technology</td>
                                            ...
                                            <td class="px-3 py-3 font-medium text-[#0B132C]">1,245</td>
                                            <td class="px-3 py-3">
                                        ...
                                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-3 py-3 text-gray-600 font-medium">Environment</td>
                                            ...
                                            <td class="px-3 py-3 font-medium text-[#0B132C]">856</td>
                                            <td class="px-3 py-3">
                                                <span class="px-2.5 py-1 bg-[#E6FBF0] text-[#10B981] rounded border border-[#bbf7d0] text-[11px] font-bold">Upcoming</span>
                                            </td>
                                            <td class="px-3 py-3">
                                        ...
                                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-3 py-3 text-gray-600 font-medium">Healthcare</td>
                                            ...
                                            <td class="px-3 py-3 font-medium text-[#0B132C]">432</td>
                                            <td class="px-3 py-3">
                                        ...
                                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-3 py-3 font-medium text-[#0B132C]">980</td>
                                            <td class="px-3 py-3">
                                        ...
                                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-3 py-3 text-gray-600 font-medium">Education</td>
                                            ...
                                            <td class="px-3 py-3 font-medium text-[#0B132C]">670</td>
                                            <td class="px-3 py-3">
                                                <span class="px-2.5 py-1 bg-[#E6FBF0] text-[#10B981] rounded border border-[#bbf7d0] text-[11px] font-bold">Completed</span>
                                            </td>
                                            <td class="px-3 py-3">
                                        ...
                                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-3 py-3 text-gray-600 font-medium">Business</td>
                                            <td class="px-3 py-3 text-gray-600">Hall B, Expo Center</td>
                                            <td class="px-3 py-3">
                                                <div class="flex flex-col">
                                            ...
                                            <td class="px-3 py-3 font-medium text-[#0B132C]">510</td>
                                            <td class="px-3 py-3">
                                                <span class="px-2.5 py-1 bg-[#E6FBF0] text-[#10B981] rounded border border-[#bbf7d0] text-[11px] font-bold">Completed</span>
                                            </td>
                                            <td class="px-3 py-3">
                                        ...
                                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-3 py-3 font-medium text-[#0B132C]">-</td>
                                            <td class="px-3 py-3">
                                        ...
                                        <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-3 py-3 text-gray-600 font-medium">Manufacturing</td>
                            ...
                            <!-- Pagination -->
                            <div class="px-3 py-3 flex flex-col sm:flex-row items-center justify-between text-[12px] text-gray-500 font-medium gap-4 border-t border-gray-100">

...
<div class="mx-6 lg:mx-8 mt-6 bg-[#F4F2FF] border border-[#E6E1FF] rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4"><div><h3 class="text-[#0B132C] font-bold">Refund Management added</h3><p class="text-[13px] text-gray-600 mt-1">Failed payments, booth cancellations, ticket refunds aur gateway settlement tracking ke liye refund module open karein.</p></div><a href="{{ url('/admin/29_refund_management') }}" class="inline-flex items-center justify-center px-4 py-2.5 rounded-xl bg-[#3723db] text-white text-[13px] font-semibold hover:bg-[#2b1bb7] transition-colors">Open Module <i class="ph ph-arrow-right ml-2"></i></a></div>
            ...
            <div class="max-w-[1600px] mx-auto">
                ...
                <div class="bg-white rounded-[16px] border border-gray-200 shadow-sm overflow-hidden mb-8">
                    ...
                    <div class="px-6 border-b border-gray-100 flex flex-col xl:flex-row xl:items-center justify-between gap-4 pt-2">
                        ...
                        <!-- Tabs -->
                        <div class="flex items-center gap-6 overflow-x-visible no-scrollbar">
                            <button class="py-4 px-1 tab-active whitespace-normal text-[14px]">All Invoices</button>
                            <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Paid</button>
                            <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Pending</button>
                            <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Overdue</button>
                            <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Cancelled</button>
                            <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Draft</button>
                        </div>

...
<body class="flex h-screen w-full overflow-hidden m-0 p-0 text-[#1E293B]">
    ...
    <main class="flex-1 flex flex-col h-full min-w-0">
        ...
        <div class="bg-white px-6 lg:px-8 border-b border-gray-100 shrink-0">
            <div class="flex items-center gap-8 overflow-x-visible no-scrollbar">
                <button class="py-4 px-1 tab-active whitespace-normal text-[14px]">Overview</button>
                <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Sales</button>
                <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Enquiries</button>
                <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Exhibitions</button>
                <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Booths</button>
                <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Tickets</button>
                <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Meetings</button>
                <button class="py-4 px-1 tab-inactive whitespace-normal text-[14px]">Users</button>
            </div>
        </div>
            ...
            <div class="max-w-[1600px] mx-auto">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 pb-8">
                    ...
                    <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm flex flex-col h-[340px]">
                        ...
                        <div class="flex-1 overflow-x-visible">
                            <table class="w-full text-left border-collapse whitespace-normal">
                                <thead>
                                    <tr class="text-[11px] text-gray-400 border-b border-gray-50 bg-gray-50/30">
                                        <th class="px-3 py-3 font-semibold">Exhibition</th>
                                        <th class="px-3 py-3 font-semibold">Revenue (₹)</th>
                                        <th class="px-3 py-3 font-semibold">Bookings</th>
                                        <th class="px-3 py-3 font-semibold">Growth</th>
                                    </tr>
                                </thead>
                                <tbody class="text-[12px]">
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#0B132C]">Global Tech Summit 2024</td>
                                        <td class="px-3 py-3 text-gray-600">₹ 4,20,000</td>
                                        <td class="px-3 py-3 text-gray-600">98</td>
                                        <td class="px-3 py-3"><span class="text-[#10B981] font-bold"><i class="ph-bold ph-arrow-up"></i> 18.6%</span></td>
                                    </tr>
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#0B132C]">Future AI Conference</td>
                                        <td class="px-3 py-3 text-gray-600">₹ 2,85,000</td>
                                        <td class="px-3 py-3 text-gray-600">72</td>
                                        <td class="px-3 py-3"><span class="text-[#10B981] font-bold"><i class="ph-bold ph-arrow-up"></i> 16.2%</span></td>
                                    </tr>
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#0B132C]">Healthcare Leaders Summit</td>
                                        <td class="px-3 py-3 text-gray-600">₹ 2,10,000</td>
                                        <td class="px-3 py-3 text-gray-600">45</td>
                                        <td class="px-3 py-3"><span class="text-[#10B981] font-bold"><i class="ph-bold ph-arrow-up"></i> 12.4%</span></td>
                                    </tr>
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#0B132C]">Smart Tech Expo 2024</td>
                                        <td class="px-3 py-3 text-gray-600">₹ 1,60,000</td>
                                        <td class="px-3 py-3 text-gray-600">32</td>
                                        <td class="px-3 py-3"><span class="text-[#10B981] font-bold"><i class="ph-bold ph-arrow-up"></i> 9.8%</span></td>
                                    </tr>
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#0B132C]">Sustainability World Expo</td>
                                        <td class="px-3 py-3 text-gray-600">₹ 90,000</td>
                                        <td class="px-3 py-3 text-gray-600">22</td>
                                        <td class="px-3 py-3"><span class="text-[#10B981] font-bold"><i class="ph-bold ph-arrow-up"></i> 7.6%</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm flex flex-col h-[340px] xl:col-span-1 sm:col-span-2">
                        ...
                        <div class="flex-1 overflow-x-visible">
                            <table class="w-full text-left border-collapse whitespace-normal">
                                <thead>
                                    <tr class="text-[11px] text-gray-400 border-b border-gray-50 bg-gray-50/30">
                                        <th class="px-3 py-3 font-semibold">Invoice ID</th>
                                        <th class="px-3 py-3 font-semibold">Customer / Company</th>
                                ...
                                <tbody class="text-[12px]">
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#3723db]">INV-2024-1567</td>
                                        <td class="px-3 py-3 text-gray-800 font-medium">TechNova Solutions</td>
                                        <td class="px-3 py-3 text-[#0B132C] font-semibold">₹ 1,20,000</td>
                                        <td class="px-3 py-3"><span class="px-2 py-0.5 bg-[#ECFDF5] text-[#10B981] rounded text-[10px] font-bold uppercase">Paid</span></td>
                                        <td class="px-3 py-3 text-gray-500">May 16, 2024</td>
                                    </tr>
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#3723db]">INV-2024-1566</td>
                                        <td class="px-3 py-3 text-gray-800 font-medium">Global Tech Solutions</td>
                                        <td class="px-3 py-3 text-[#0B132C] font-semibold">₹ 1,50,000</td>
                                        <td class="px-3 py-3"><span class="px-2 py-0.5 bg-[#ECFDF5] text-[#10B981] rounded text-[10px] font-bold uppercase">Paid</span></td>
                                        <td class="px-3 py-3 text-gray-500">May 16, 2024</td>
                                    </tr>
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#3723db]">INV-2024-1565</td>
                                        <td class="px-3 py-3 text-gray-800 font-medium">Future AI Conference</td>
                                        <td class="px-3 py-3 text-[#0B132C] font-semibold">₹ 75,000</td>
                                        <td class="px-3 py-3"><span class="px-2 py-0.5 bg-[#ECFDF5] text-[#10B981] rounded text-[10px] font-bold uppercase">Paid</span></td>
                                        <td class="px-3 py-3 text-gray-500">May 15, 2024</td>
                                    </tr>
                                    <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#3723db]">INV-2024-1564</td>
                                        <td class="px-3 py-3 text-gray-800 font-medium">SmartTech Pvt. Ltd.</td>
                                        <td class="px-3 py-3 text-[#0B132C] font-semibold">₹ 90,000</td>
                                        <td class="px-3 py-3"><span class="px-2 py-0.5 bg-[#FFF7ED] text-[#EA580C] rounded text-[10px] font-bold uppercase">Pending</span></td>
                                        <td class="px-3 py-3 text-gray-500">May 15, 2024</td>
                                    </tr>
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        <td class="px-3 py-3 font-medium text-[#3723db]">INV-2024-1563</td>
                                        <td class="px-3 py-3 text-gray-800 font-medium">InnovateX Corp.</td>
                                        <td class="px-3 py-3 text-[#0B132C] font-semibold">₹ 60,000</td>
                                        <td class="px-3 py-3"><span class="px-2 py-0.5 bg-[#FEF2F2] text-[#EF4444] rounded text-[10px] font-bold uppercase">Overdue</span></td>
                                        <td class="px-3 py-3 text-gray-500">May 15, 2024</td>
                                    </tr>
                                </tbody>
                            </table>

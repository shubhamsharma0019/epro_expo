...
<body class="exhibition-app bg-[#F5F7FC] font-sans text-navy overflow-x-hidden antialiased">
    ...
    <script>
        (() => {
            ...
            const openButtons = document.querySelectorAll('[data-sidebar-open], [data-user-sidebar-open]');
            const closeButtons = document.querySelectorAll('[data-sidebar-close], [data-user-sidebar-close]');

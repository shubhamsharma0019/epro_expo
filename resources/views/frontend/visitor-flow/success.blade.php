            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1 flex flex-col pb-10">
                    ...
                    <div class="flex items-center justify-center gap-4 mb-12">
                        <a href="{{ route('exhibitions.tickets.e-ticket', $slug) }}" class="btn-e-ticket bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-xl font-bold shadow-[0_4px_14px_rgba(90,50,250,0.25)] transition-all text-[15px] flex items-center gap-2">
                            <i class="ph ph-ticket"></i> View E-Ticket
                        </a>
                        <a href="{{ route('exhibitions.visitor.dashboard', $slug) }}" class="border border-primary-200 bg-white text-primary-600 hover:bg-primary-50 px-8 py-3 rounded-xl font-bold transition-all text-[15px] flex items-center gap-2 shadow-sm">
                            <i class="ph ph-monitor"></i> Go to Dashboard
                        </a>
    ...
    <script>
        async function initializeSuccessPage() {
            ...
            if (visitor) {
                ...
                if (ticketBtn) {
                    ticketBtn.href = `{{ route('exhibitions.tickets.e-ticket', $slug) }}?booking_id=${visitor.booking_id}&id=${exhId}`;
                }
            }
        }

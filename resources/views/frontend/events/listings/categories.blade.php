...
<main class="px-4 md:px-[44px] pt-8 pb-10">
    ...
    <div class="rounded-2xl border border-[#E8E3F0] bg-white p-7 shadow-[0_1px_2px_rgba(27,36,87,0.02)]">
        ...
        <a href="{{ url('/events/listings/search') }}" class="mt-7 inline-flex rounded-xl bg-[#4318FF] px-7 py-3 text-[15px] font-bold text-white shadow-[0_8px_20px_rgba(67,24,255,0.25)]">Search Events</a>
    </div>
</main>
@endsection

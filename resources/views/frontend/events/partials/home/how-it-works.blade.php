<div id="how-it-works" class="h-full rounded-[10px] border border-[#F0EEF8] bg-white px-4 py-5 shadow-[0_18px_42px_rgba(31,42,106,0.07)] sm:px-7 sm:py-7">
    <h2 class="text-[20px] font-extrabold leading-none tracking-[-0.01em] text-[#191D4D] sm:text-[24px]">How It Works</h2>

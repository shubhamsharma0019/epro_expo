...
@section('content')
<main class="flex-1 px-[32px] pt-[18px] pb-12">
            <section class="mx-auto w-full max-w-[1080px]">
                ...
                <div id="ticketCard" class="overflow-hidden rounded-[13px] border border-[#3B47C8] bg-white">
                    <div class="grid grid-cols-[1fr_330px] min-h-[292px]">
                        <div class="relative overflow-hidden bg-[#06154B] px-[43px] py-[48px] text-white">
                        ...
                        <div class="relative flex items-center justify-center border-l border-dashed border-[#D9DDF4] bg-[#FBFCFF] px-[42px] py-[38px]">
                    ...
                    <div class="px-[34px] py-[27px]">
                        <div class="grid grid-cols-[310px_1fr] gap-y-[20px] text-[19px] leading-none">
                        ...
                        <div class="mt-[35px] border-t border-[#D9DDF4] pt-[25px] text-center text-[18px] font-bold text-[#071044]">

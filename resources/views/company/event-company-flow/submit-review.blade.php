        ...
        <div class="flex flex-col xl:flex-row gap-10 md:gap-14">
                ...
                <div>
                    ...
                    <div class="border border-gray-100 rounded-[12px] bg-white flex flex-col shadow-[0_2px_8px_rgba(0,0,0,0.01)] overflow-hidden">
                        ...
                        @foreach ($checklistItems as $item)
                            ...
                            @endphp
                            <div class="flex items-center justify-between p-4 px-5 {{ $loop->last ? '' : 'border-b border-gray-50' }} hover:bg-gray-50/50 transition-colors">
            ...
            <div class="w-full xl:w-[440px] flex flex-col gap-10">
                ...
                <div>
                    ...
                    <!-- Alert Box -->
                    <div class="{{ $requiredComplete ? 'bg-[#F0FDF4] border-[#DCFCE7]' : 'bg-[#FFFBEB] border-[#FEF3C7]' }} border rounded-[12px] p-6 flex gap-4">
                        ...
                        <div class="flex min-h-[170px] flex-col gap-3">
                            @if (filled($eventBranding?->brochure_path))
                                <div id="brochure-slot" class="border border-gray-100 rounded-[12px] bg-[#FCFCFD] p-4 flex items-center justify-between gap-4 shadow-sm">
                                    ...
                                    <a href="{{ asset('storage/' . $eventBranding->brochure_path) }}" target="_blank" rel="noopener" class="inline-flex h-9 items-center justify-center rounded-lg border border-[#E8E3FF] px-4 text-[12px] font-bold text-[#4C10D0] hover:bg-[#F4F1FF]">View</a>
                                </div>
                            @endif
                            ...
                            @if (filled($companyEvent->website))
                                <div id="guide-slot" class="border border-gray-100 rounded-[12px] bg-[#FCFCFD] p-4 flex items-center justify-between gap-4 shadow-sm">
                                    ...
                                    <a href="{{ \Illuminate\Support\Str::startsWith($companyEvent->website, ['http://', 'https://']) ? $companyEvent->website : 'https://' . $companyEvent->website }}" target="_blank" rel="noopener" class="inline-flex h-9 items-center justify-center rounded-lg border border-[#E8E3FF] px-4 text-[12px] font-bold text-[#4C10D0] hover:bg-[#F4F1FF]">Open</a>
                                </div>
                            @endif

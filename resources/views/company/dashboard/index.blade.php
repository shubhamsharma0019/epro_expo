...
@php
    ...
    $setupHref = $latestBooking 
        ...
        : ($pendingBooking ? '#' : url('/company/booth-booking/pavilions'));
    ...
    $floorPlanHref = $latestBooking
        ...
        : ($pendingBooking
            ...
            : url('/company/booth-booking/pavilions'));
...
<section class="mx-auto w-full max-w-[1400px] p-4 sm:p-6 lg:p-8">
    ...
    @elseif (!$latestBooking)
        <div class="mb-8 rounded-2xl border border-[#E4DEFF] bg-[#FBFAFF] p-5 shadow-sm sm:p-6">
            <div class="flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
                ...
                <a href="{{ url('/company/booth-booking/pavilions') }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-6 py-3 text-sm font-bold text-white shadow-sm transition-colors hover:bg-blue-700">
    ...
    <div class="mb-8 flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
        ...
        <div class="relative w-full sm:min-w-[240px] lg:w-auto">
            <select onchange="if (this.value) window.location.href = this.value" class="w-full appearance-none rounded-xl border border-gray-200 bg-white py-3 pl-4 pr-10 font-medium text-gray-700 shadow-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary">
                ...
                @endforeach
                <option value="{{ url('/company/booth-booking/pavilions') }}">Book another exhibition booth</option>
            </select>
    ...
    <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
        <div class="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <a href="{{ $latestBooking ? route('company.booth-setup.products.index', $latestBooking) : url('/company/booth-booking/pavilions') }}" class="mt-4 text-[13px] font-bold text-primary">Manage Products</a>
        </div>
        <div class="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <a href="{{ $latestBooking ? route('company.booth-setup.documents.index', $latestBooking) : url('/company/booth-booking/pavilions') }}" class="mt-4 text-[13px] font-bold text-primary">Manage Documents</a>
        </div>
        <div class="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <a href="{{ $latestBooking ? route('company.booth-setup.catalogues.index', $latestBooking) : url('/company/booth-booking/pavilions') }}" class="mt-4 text-[13px] font-bold text-primary">Manage Catalogues</a>
        </div>
        <div class="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
    ...
    <div class="mb-8 rounded-2xl border border-[#3b18ff]/10 bg-[#f4f2ff] p-6 sm:p-8">
        <div class="flex flex-col items-start gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex shrink-0 flex-col gap-3 sm:flex-row w-full lg:w-auto">
                <a href="{{ url('/company/booth-booking/pavilions') }}" class="flex h-12 w-full min-w-[180px] items-center justify-center gap-2 rounded-xl border-2 border-[#3b18ff] bg-[#3b18ff] px-6 text-[15px] font-bold text-white shadow-sm shadow-[#3b18ff]/20 transition-all hover:bg-[#3111e8] hover:shadow-md hover:-translate-y-0.5 sm:w-auto">
    ...
    <div class="mb-8 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm sm:p-6">
        <div class="mb-5 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <a href="{{ url('/company/booth-booking/pavilions') }}" class="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-primary px-5 text-sm font-bold text-white shadow-sm transition-colors hover:bg-blue-700">

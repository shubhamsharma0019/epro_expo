...
@php
    ...
    $viewUrl = function (string $mode) use ($search) {
...
<section class="w-full max-w-[1500px] px-4 py-6 sm:px-8 sm:py-8 lg:px-10 lg:py-10">
    ...
    <div class="{{ $cardsClass }}">
        ...
        @forelse ($pavilions as $pavilion)
            @php
                $hallCount = $pavilion->halls_count ?: (int) $pavilion->total_halls;
                $boothCount = $pavilion->halls->sum('total_booths') ?: (int) $pavilion->total_booths;
            ...
            @if ($viewMode === 'list')
                <div class="overflow-hidden rounded-xl border border-borderColor bg-white p-4 shadow-sm">
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-[220px_minmax(0,1fr)_180px] lg:items-center lg:gap-5">
                        ...
                        <a href="{{ url('/company/booth-booking/halls?pavilion=' . $pavilion->id) }}" class="inline-flex h-[46px] w-full items-center justify-center gap-3 rounded-md border border-purple px-5 text-[14px] font-semibold text-purple lg:w-auto">
                            View Details
            ...
            @elseif ($viewMode === 'compact')
                <div class="overflow-hidden rounded-xl border border-borderColor bg-white shadow-sm">
                    ...
                    <div class="p-4 sm:p-5">
                        ...
                        <a href="{{ url('/company/booth-booking/halls?pavilion=' . $pavilion->id) }}" class="mt-4 inline-flex items-center gap-3 text-[14px] font-semibold text-purple">
                            View Details
            ...
            @else
                <div class="overflow-hidden rounded-xl border border-borderColor bg-white shadow-sm">
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <a href="{{ url('/company/booth-booking/halls?pavilion=' . $pavilion->id) }}" class="inline-flex items-center gap-3 text-[15px] font-semibold text-purple">
                            View Details
                            <i class="fa-solid fa-arrow-right text-[13px]"></i>
                        </a>
                    </div>

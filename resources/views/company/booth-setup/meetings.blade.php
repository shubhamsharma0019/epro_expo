                ...
                <div class="md:col-span-7 border border-gray-100 rounded-xl p-6 bg-white shadow-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        @foreach ($weekdays as $day)
                            ...
                            <label data-weekday-row class="flex items-center justify-between gap-4 rounded-lg border {{ $checked ? 'border-[#4C1D95] bg-[#F5F3FF]' : 'border-gray-100 bg-white' }} px-4 py-3 cursor-pointer">
                                <span class="flex items-center min-w-0">
                                    ...
                                    <span data-weekday-name class="ml-3 text-[14px] font-semibold {{ $checked ? 'text-[#1E1B4B]' : 'text-[#4B5563]' }}">{{ $day }}</span>
                                </span>

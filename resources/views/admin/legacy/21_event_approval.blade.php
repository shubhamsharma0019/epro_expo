            ...
            <div class="max-w-[1600px] mx-auto">
                ...
                <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ url('/admin/22_event_setup_review') }}" class="flex items-center justify-center gap-2 bg-white border border-gray-200 text-gray-600 hover:text-gray-800 px-4 py-2 rounded-lg text-[13px] font-bold shadow-sm hover:bg-gray-50 transition-colors">
                ...
                <div class="flex flex-col gap-6 items-start">
                    ...
                    <div class="w-full xl:flex-1 flex flex-col gap-6">
                        ...
                        <!-- Tabs Navigation -->
                        <div class="flex overflow-x-visible border-b border-gray-200 hide-scrollbar mt-2">
                            <button class="px-3 py-3 text-[13px] font-bold text-[#3723db] border-b-2 border-[#3723db] whitespace-normal">Event Setup Details</button>
                            <button class="px-3 py-3 text-[13px] font-medium text-gray-500 hover:text-gray-800 whitespace-normal transition-colors">Agenda & Sessions</button>
                            <button class="px-3 py-3 text-[13px] font-medium text-gray-500 hover:text-gray-800 whitespace-normal transition-colors">Speakers</button>
                            <button class="px-3 py-3 text-[13px] font-medium text-gray-500 hover:text-gray-800 whitespace-normal transition-colors">Sponsors</button>
                            <button class="px-3 py-3 text-[13px] font-medium text-gray-500 hover:text-gray-800 whitespace-normal transition-colors">Promotion Plan</button>
                            <button class="px-3 py-3 text-[13px] font-medium text-gray-500 hover:text-gray-800 whitespace-normal transition-colors">Documents & Media</button>
                            <button class="px-3 py-3 text-[13px] font-medium text-gray-500 hover:text-gray-800 whitespace-normal transition-colors">Additional Information</button>
                        </div>

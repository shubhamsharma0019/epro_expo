...
@section('title', 'Booth Setup Review - Preview')
@section('page-title', 'Booth Setup Review')
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
                ...
                <div class="xl:col-span-2 flex flex-col gap-6">
                    ...
                    <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm flex flex-col">
                        <!-- Tabs -->
                        <div class="flex items-center gap-6 px-6 lg:px-8 border-b border-gray-100 overflow-x-auto main-scrollbar whitespace-nowrap flex-nowrap">
                    ...
                    <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm p-6 lg:p-8">
                        ...
                        <form>
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 w-full">
                                <button type="button" class="w-full sm:flex-1 px-4 py-3 rounded-[10px] text-[13px] font-bold text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 transition-colors shadow-sm text-center">
                                    Cancel
                                </button>
                                <button type="button" class="w-full sm:flex-1 px-4 py-3 rounded-[10px] text-[13px] font-bold text-[#3723db] bg-[#F4F2FF] border border-[#F4F2FF] hover:bg-[#e9e4ff] transition-colors shadow-sm text-center">
                                    Save as Draft
                                </button>
                                <button type="button" class="w-full sm:flex-1 px-4 py-3 rounded-[10px] text-[13px] font-bold text-white bg-[#3723db] hover:bg-[#2515a6] transition-colors shadow-sm text-center">
                                    Submit Review
                                </button>
                            </div>
                        </form>

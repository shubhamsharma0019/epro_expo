        ...
        <div class="flex-1 overflow-y-auto overflow-x-hidden p-6 lg:p-8 main-scrollbar">
            <div class="max-w-[1400px] mx-auto">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    ...
                    <div>
                        <button onclick="window.location.href='13_add_hall.html'" class="flex items-center justify-center gap-2 bg-[#3723db] hover:bg-[#2515a6] text-white px-5 py-2.5 rounded-[10px] text-[14px] font-semibold shadow-md transition-all w-full sm:w-auto">
                        ...
                        <table class="w-full text-left border-collapse whitespace-normal">
                            <thead>
                                <tr class="text-[13px] text-gray-500 font-semibold border-b border-gray-100 bg-white">
                                    ...
                                    <th class="px-3 py-3 flex items-center gap-1 cursor-pointer hover:text-gray-700">Exhibition <i class="ph ph-caret-up-down text-[10px]"></i></th>
                                    <th class="px-3 py-3 flex items-center gap-1 cursor-pointer hover:text-gray-700">Pavilion <i class="ph ph-caret-up-down text-[10px]"></i></th>
                                    ...
                                    <th class="px-3 py-3 flex items-center gap-1 cursor-pointer hover:text-gray-700">Capacity <i class="ph ph-caret-up-down text-[10px]"></i></th>

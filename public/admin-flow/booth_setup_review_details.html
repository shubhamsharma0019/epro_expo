                ...
                <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-8">
                    ...
                    <div class="flex flex-col items-end gap-4">
                        ...
                        <div class="flex items-center gap-3 mt-2 md:mt-6">
                            <a href="booth_setup_review.html" class="flex items-center gap-2 px-4 py-2.5 rounded-[10px] text-[13px] font-semibold text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 transition-colors shadow-sm">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
                    ...
                    <div class="xl:col-span-2 flex flex-col gap-6">
                        ...
                        <div class="bg-white rounded-[16px] border border-gray-100 shadow-sm flex flex-col">
                            <!-- Tabs -->
                            <div class="flex items-center gap-6 px-6 lg:px-8 border-b border-gray-100 overflow-x-auto main-scrollbar whitespace-nowrap">

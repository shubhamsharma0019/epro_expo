                ...
                <div class="flex flex-col xl:flex-row gap-6 h-[calc(100vh-270px)] min-h-[700px]">
                    ...
                    <div class="flex-1 bg-white rounded-[16px] border border-gray-100 shadow-sm flex flex-col overflow-hidden min-w-0">
                        ...
                        <div class="px-6 border-b border-gray-100 flex gap-6 overflow-x-auto no-scrollbar pt-4">
                            <button class="pb-3 tab-active text-[13px] whitespace-nowrap px-1">Pages</button>
                            <button class="pb-3 tab-inactive text-[13px] whitespace-nowrap px-1">Menus</button>
                            <button class="pb-3 tab-inactive text-[13px] whitespace-nowrap px-1">Banners / Sliders</button>
                            <button class="pb-3 tab-inactive text-[13px] whitespace-nowrap px-1">Content Blocks</button>
                            <button class="pb-3 tab-inactive text-[13px] whitespace-nowrap px-1">Media Library</button>
                            <button class="pb-3 tab-inactive text-[13px] whitespace-nowrap px-1">SEO Settings</button>
                        </div>
                        ...
                        <div class="px-6 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            ...
                            <div class="flex items-center gap-3 w-full sm:w-auto">
                                ...
                                <button class="flex items-center gap-2 bg-white border border-gray-200 px-4 py-2 rounded-[8px] text-[13px] font-semibold text-[#3723db] shadow-sm hover:bg-gray-50 transition-colors whitespace-nowrap">
                                    Bulk Actions
                        ...
                        <!-- Table Wrapper -->
                        <div class="flex-1 overflow-x-auto overflow-y-auto main-scrollbar w-full border-t border-gray-100">
                            <table class="w-full text-left border-collapse min-w-[900px]">
                                <thead>
                                    <tr class="text-[12px] text-gray-500 border-b border-gray-50 bg-white sticky top-0 z-10">
                                        ...
                                        <th class="px-6 py-4 font-semibold w-[160px]">Actions</th>
                                    </tr>
                                </thead>
